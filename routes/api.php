...
Route::get('/analyze-link', 'Tool\ApiController@analyzeLink')->name('api.analyze-link');
Route::get('/keyword-research','Tool\ApiController@keywordResearch')->name('api.keyword-research');
