...
return [
    ...
    "copy-1"=>"<p>PageSpeed tool by CMLABS reviews the overall performance of a web page on each cellular and laptop gadgets, and affords hints on how that web page can be improved.</p>
        <p><strong>PageSpeed Tool by CMLABS</strong> shows each lab and discipline records approximately a web page. Lab records are beneficial for debugging overall performance issues, as it's miles gathered in a managed environment. However, it could now no longer seize real-world bottlenecks. Field records is beneficial for taking pictures true, international consumer enjoy - however has an extra restrained set of metrics.</p>",
