...
return [
    ...
    "lang" => "en",
    "title-0" => "Free SEO Tools",
    "sub-title-0" => "SPECIALLY DEVELOPED FOR CONTENT AND WEB ENTHUSIAST",
    "desc-1" => "PT CMLABS INDONESIA DIGITAL is a company that focuses on SEO services, Marketing and platforms to support SEO activities. Generally, we use a short name, CMLABS, which stands for Content Marketing Labs.",
    "desc-2" => "The company was initiated when the three founders observed the distance between consumers and the product they seek, especially in Indonesian online market. The founders came with the idea to help more enterprises to expand the reach of their brands on the internet.",
    "desc-3" => "The first step was taken on April 29, 2019, when the cmlabs company was officially established in North Jakarta. Subsequently, on November 1 2019, cmlabs expanded its wings by establishing a second office in Malang, East Java.",
    "desc-4" => "Until today, cmlabs specializes in three fields: content writing, SEO specialist, and SEO campaign. Driven by a team consisting of experts in their fields, cmlabs will develop even further and will reach even wider market. <a href='https://cmlabs.co/en/' target='_blank'><b>Visit the Website</b></a>.",
    "title-1" => "Tools",
    "title-2" => "SEO Experts",
    "sub-title-2-1" => "All About Data-Driven and The Problems of Data Scientists",
    "desc-2-1-1" => "Empowering data and awareness of data literacy from top to bottom (data-driven) is an ecosystem, not just a linear process. There are two methods used by data scientists. What are the advantages and disadvantages of each? Learn more about data driven here.",
    "url-1" => "https://cmlabs.co/en/what-is-data-driven/",
    "sub-title-2-2" => "Content Writing – Guides & How to Create SEO Articles",
    "desc-2-2-1" => "For beginners who are just about to learn or even experts, writing activity has its own challenges. Especially in terms of writing SEO articles. Want to learn how to make SEO articles? Here, cmlabs online guide will help you learn what content writing is in the right way!",
    "url-2" => "https://cmlabs.co/en/seo-content-guideline/",
    "sub-title-2-3" => "How SEO Marketing Supports SMEs and STARTUP",
    "desc-2-3-1" => "Business owners often feel confused about what strategy to take to bring their brand to the face of potential customers, especially online. For SMEs / MSMEs and startups, SEO is important because it is the marketing with the lowest acquisition cost. Prove it now!",
    "url-3" => "https://cmlabs.co/en/seo-for-sme-startup/",
    "sub-title-2-4" => "SEO Copywriting, 5 Key Points For Content Optimization",
    "desc-2-4-1" => "Writing is never easy, but there are always certain tricks for producing high quality content. In SEO copywriting, you need to pay attention to a number of aspects for content optimization. Are you a new copywriter? Don't worry, these 5 points will help.",
    "url-4" => "https://cmlabs.co/en/seo-copywriting-content-optimization/",
    "sub-title-2-5" => "My Theorem & Alibi for Google SEO in Indonesia",
    "desc-2-5-1" => "Marketing in every era has its own style. As the internet grew, a new term for content optimization in search engines began to emerge, known as SEO. Read arguments and arguments related to the development of SEO marketing, especially in Indonesia. By Rochman Maarif, SEO Specialist.",
    "url-5" => "https://cmlabs.co/en/theorem-alibi-seo/",
    "sub-title-2-6" => "What is Search Intent and How to Target Customers",
    "desc-2-6-1" => "Have you ever typed keywords in Google and the results you wanted immediately came up? That's because Google understands the Search Intent of the keywords. Search intent (or user intent, audience intent) is a term used to describe a search objective on Google search.",
    "url-6" => "https://cmlabs.co/en/customer-google-search/",
