                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-10 mb-5">
                            <div id="spinner">
                                <input type="text" name="" class="form-control" value="" id="url"
                                       placeholder="@lang('mobiletest.question')">
                            </div>
                        </div>
                        <div class="col-lg-2 mb-5">
                            <button type="button" class="btn btn-success form-control" name="button"
                                    id="btn-check">@lang('mobiletest.btn-add')</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row" >
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-sm-8 col-md-10 col-lg-8">
                                    ...
                                    <h1 id="result-title">Page is mobile friendly</h1>
                                ...
                                <div class="col-12 col-sm-4 col-md-2 col-lg-4" id="icon">
                                    <div class="success-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             ...
                                             style="enable-background:new 0 0 300 300;" width="100%">
                                            <g>
                                                <g>
                                                    <g>
                                                        <g>
                                                            <circle cx="150.001" cy="226.085" r="11.718"
                                                                    ...
                                                                    data-old_color="#000000" fill="#36D153"/>
                                                            <path
                                    ...
                                    <div class="error-icon" style="display: none;">
                                        <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1"
                                             enable-background="new 0 0 510 510" viewBox="0 0 510 510" width="100%">
                                            <g>
                                                <g>
                                                    <path d="m326.671 315h3.329v-135h-137.737z" data-original="#000000"
                                                          class="active-path" data-old_color="#000000" fill="#E82525"/>
                                                    <path
                                                        d="m317.763 120h-125.525c-6.748 0-12.238 5.49-12.238 12.238v17.762h150v-17.762c0-6.748-5.489-12.238-12.237-12.238z"
                                                        data-original="#000000" class="active-path"
                                                    ...
                                                    <path
                                                        ...
                                                        data-original="#000000" class="active-path"
                                                        data-old_color="#000000" fill="#E82525"/>
                                                    <path d="m284.337 315-104.337-104.796v104.796z"
                                                          data-original="#000000" class="active-path"
                                                          data-old_color="#000000" fill="#E82525"/>
                                                    <path
                                                        ...
                                                        data-old_color="#000000" fill="#E82525"/>
                                                    <path
                                                        d="m192.238 390h125.525c6.748 0 12.237-5.49 12.237-12.238v-16.898l-15.794-15.864h-134.206v32.762c0 6.748 5.49 12.238 12.238 12.238z"
                                                        data-original="#000000" class="active-path"
                                                        data-old_color="#000000" fill="#E82525"/>
                                                </g>
                                            </g>
        ...
        <div class="col-lg-5 mb-5">
            <div class="card card-custom card-stretch">
                ...
                <div class="card-body">
                    <img id="result-image" src="https://help.quickbase.com/user-assistance/images/mobile-preview-small.png" width="100%"
                         height="auto" alt="">
                </div>
            </div>
        </div>
                            ...
                            @endif
                                <span class="bullet bullet-bar {{$color}} align-self-stretch"></span>
                                            <div class="d-flex flex-column flex-grow-1 mx-4">
                                                @if($local == "en")
                                                    <a href="{{$dataEN[$i]['link']}}" data-toggle="tooltip"
                                                       title="{{$dataEN[$i]['title']}}"
                                                       class="text-dark-75 text-hover-primary font-weight-bold font-size-lg mb-1">{{substr($dataEN[$i]['title'],0,strpos($dataEN[$i]['title'], ' ', 20))}}
                                                        ...</a>
                                                    <span
                                                        class="text-muted font-weight-bold">{{$dataEN[$i]['date']}}</span>
                                                @else
                                                    <a href="{{$dataID[$i]['link']}}" data-toggle="tooltip"
                                                       title="{{$dataID[$i]['title']}}"
                                                       class="text-dark-75 text-hover-primary font-weight-bold font-size-lg mb-1">{{substr($dataID[$i]['title'],0,strpos($dataID[$i]['title'], ' ', 20))}}
                                                        ...</a>
                                                    <span
                                                        class="text-muted font-weight-bold">{{$dataID[$i]['date']}}</span>
                                                @endif
                                            </div>
                                        </div>
                                    @endfor
