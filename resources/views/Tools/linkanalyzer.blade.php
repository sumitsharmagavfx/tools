    ...
    <div class="container container-description">
        ...
        <div class="row mb-10">
            <div class="col-md-6">
                ...
                <p class="text-black" style="font-size:1.5rem">@lang('layout.feature-sub-title') LINK ANALYZER</p>
        ...
        <h2 class="text-black">@lang('layout.whats-new-title') Link Analyzer</h2>
        <div class="row my-5">
