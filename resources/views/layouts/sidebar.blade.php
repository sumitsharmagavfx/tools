      ...
      <div id="kt_aside_menu" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
        ...
        <ul class="menu-nav mb-25">            
          <li class="menu-item mb-5 @yield('home')" aria-haspopup="true">
            ...
            <li class="menu-item mb-5 @yield('json-ld-article')">
              <a href="/{{$local}}/json-ld-article-schema-generator" class="menu-link">
                <span class="svg-icon menu-icon">
                  <!--begin::Svg Icon-->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="menu-text">JSON-LD Article</span>
              </a>
            </li>


            <li class="menu-item mb-5 @yield('json-ld-person')">
              <a href="/{{$local}}/json-ld-person-schema-generator" class="menu-link">
                <span class="svg-icon menu-icon">
                  <!--begin::Svg Icon-->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="menu-text">JSON-LD Person</span>
              </a>
            </li>

            <li class="menu-item mb-5 @yield('json-ld-howto')">
              <a href="/{{$local}}/json-ld-howto-schema-generator" class="menu-link">
                <span class="svg-icon menu-icon">
                  <!--begin::Svg Icon-->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="menu-text">JSON-LD howto</span>
              </a>
            </li>

            <li class="menu-item mb-5 @yield('json-ld-breadcrumb')">
              <a href="/{{$local}}/json-ld-breadcrumb-schema-generator" class="menu-link">
                <span class="svg-icon menu-icon">
                  <!--begin::Svg Icon-->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="menu-text">JSON-LD breadcrumb</span>
              </a>
            </li>

            <li class="menu-item mb-5 @yield('json-ld-recipe')">
              <a href="/{{$local}}/json-ld-recipe-schema-generator" class="menu-link">
                <span class="svg-icon menu-icon">
                  <!--begin::Svg Icon-->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="menu-text">JSON-LD recipe</span>
              </a>
            </li>

            <li class="menu-item mb-5 @yield('json-ld-jobPosting')">
              <a href="/{{$local}}/json-ld-jobPosting-schema-generator" class="menu-link">
                <span class="svg-icon menu-icon">
                  <!--begin::Svg Icon-->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="menu-text">JSON-LD job Posting</span>
              </a>
            </li>

            <li class="menu-item mb-5 @yield('json-ld-product')">
              <a href="/{{$local}}/json-ld-product-schema-generator" class="menu-link">
                <span class="svg-icon menu-icon">
                  <!--begin::Svg Icon-->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="menu-text">JSON-LD Product</span>
              </a>
            </li>

            <li class="menu-item mb-5 @yield('json-ld-event')">
              <a href="/{{$local}}/json-ld-event-schema-generator" class="menu-link">
                <span class="svg-icon menu-icon">
                  <!--begin::Svg Icon-->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="menu-text">JSON-LD event</span>
              </a>
            </li>
